...
public class CallActivity extends BaseActivity implements DuringCallEventHandler {
    ...
    protected void initUIandEvent() {
        ...
        String channelName = getIntent().getStringExtra(CurrentUserSettings.ACTION_KEY_CHANNEL_NAME);
        ...
        final String encryptionKey = getIntent().getStringExtra(CurrentUserSettings.ACTION_KEY_ENCRYPTION_KEY);
        final String encryptionMode = getIntent().getStringExtra(CurrentUserSettings.ACTION_KEY_ENCRYPTION_MODE);
    ...
    private void doConfigEngine(String encryptionKey, String encryptionMode) {
         configEngine(encryptionKey, encryptionMode);
    }
    ...
    private void doHandleExtraCallback(int type, Object... data) {
        ...
        switch (type) {
            ...
            case AGEventHandler.EVENT_TYPE_ON_APP_ERROR:
                ...
                if (subType == CurrentUserSettings.AppError.NO_CONNECTION_ERROR) {
    ...
    private void switchToDefaultVideoView() {
        ...
        if (sizeLimit > CurrentUserSettings.MAX_PEER_COUNT + 1) {
            sizeLimit = CurrentUserSettings.MAX_PEER_COUNT + 1;
        }
